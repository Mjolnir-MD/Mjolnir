#define BOOST_TEST_MODULE "test_omp_contact_interaction"
...
BOOST_AUTO_TEST_CASE(omp_Contact_calc_force)
{
    ...
    for(int num_thread=1; num_thread<=max_number_of_threads; ++num_thread)
    {
        ...
        potential_type   potential(/* k = */100.0, /*sigma = */0.5, /* native length = */ 5.0);
