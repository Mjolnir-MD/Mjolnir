...
BOOST_AUTO_TEST_CASE(omp_BondAngle)
{
    ...
    using omp_interaction_type = mjolnir::BondAngleInteraction<omp_traits_type, potential_type>;

    using seq_system_type      = mjolnir::System<seq_traits_type>;
    using seq_interaction_type = mjolnir::BondAngleInteraction<seq_traits_type, potential_type>;
    ...
    for(int num_thread=1; num_thread<=max_number_of_threads; ++num_thread)
    {
        ...
        omp_sys.position(1) = mjolnir::math::make_coordinate<coordinate_type>( 5.0,  0.0, 0.0);
        omp_sys.position(2) = mjolnir::math::make_coordinate<coordinate_type>( 5.0,  5.0, 0.0);
        omp_sys.position(3) = mjolnir::math::make_coordinate<coordinate_type>(10.0,  5.0, 0.0);
        omp_sys.position(4) = mjolnir::math::make_coordinate<coordinate_type>(10.0, 10.0, 0.0);
        omp_sys.position(5) = mjolnir::math::make_coordinate<coordinate_type>(15.0, 10.0, 0.0);
        omp_sys.position(6) = mjolnir::math::make_coordinate<coordinate_type>(15.0, 15.0, 0.0);
        omp_sys.position(7) = mjolnir::math::make_coordinate<coordinate_type>(20.0, 15.0, 0.0);
        omp_sys.position(8) = mjolnir::math::make_coordinate<coordinate_type>(20.0, 20.0, 0.0);
        omp_sys.position(9) = mjolnir::math::make_coordinate<coordinate_type>(25.0, 20.0, 0.0);
