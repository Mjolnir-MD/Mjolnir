#define BOOST_TEST_MODULE "test_read_wca_potential"
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_wca_noenv, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_wca.log");
    ...
    using potential_type = mjolnir::WCAPotential<real_type>;
    {
        ...
        const auto& para = dynamic_cast<
            mjolnir::LorentzBerthelotRule<traits_type, potential_type> const&
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_wca_env, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_wca.log");
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_wca_ignore_self, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_wca.log");
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_wca_ignore_others, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_wca.log");
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_wca_ignore_group, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_wca.log");
