...
BOOST_AUTO_TEST_CASE(test_CellList_UnlimitedBoundary_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_cell_list.log");
    using traits_type     = mjolnir::SimulatorTraits<double, mjolnir::UnlimitedBoundary>;
    using real_type       = typename traits_type::real_type;
    ...
    using coordinate_type = typename traits_type::coordinate_type;
    using potential_type  = dummy_potential<real_type>;
    using cell_list_type  = mjolnir::UnlimitedGridCellList<traits_type, potential_type, false>;
...
BOOST_AUTO_TEST_CASE(test_CellList_UnlimitedBoundary_partial_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_cell_list.log");
...
BOOST_AUTO_TEST_CASE(test_CellList_UnlimitedBoundary_partial_2_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_cell_list.log");
