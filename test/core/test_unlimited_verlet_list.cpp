#define BOOST_TEST_MODULE "test_unlimited_verlet_list"
...
BOOST_AUTO_TEST_CASE(test_VerletList_UnlimitedBoundary_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_unlimited_verlet_list.log");
    using traits_type      = mjolnir::SimulatorTraits<double, mjolnir::UnlimitedBoundary>;
    using real_type        = typename traits_type::real_type;
...
BOOST_AUTO_TEST_CASE(test_VerletList_UnlimitedBoundary_partial_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_unlimited_verlet_list.log");
...
BOOST_AUTO_TEST_CASE(test_VerletList_UnlimitedBoundary_partial_2_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_unlimited_verlet_list.log");
