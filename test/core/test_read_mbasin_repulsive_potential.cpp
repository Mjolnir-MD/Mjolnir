#define BOOST_TEST_MODULE "test_read_mbasin_repulsive_potential"
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_mbasin_repulsive_noenv, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_mbasin_repulsive.log");
    ...
    using real_type = T;
    {
        ...
        const auto g = mjolnir::read_mbasin_repulsive_potential<real_type>(v, env);
        BOOST_TEST(g.k()  == real_type(3.14), tolerance<real_type>());
        BOOST_TEST(g.v0() == real_type(2.71), tolerance<real_type>());
    }
}

BOOST_AUTO_TEST_CASE_TEMPLATE(read_mbasin_repulsive_env, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_mbasin_repulsive.log");
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_local_potential_mbasin_repulsive_noenv, T, test_types)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_local_potential_mbasin_repulsive_env, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_harmonic.log");
