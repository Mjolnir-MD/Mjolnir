#define BOOST_TEST_MODULE "test_read_reapulsive_go_contact_potential"
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_go_contact_repulsive_noenv, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_go_contact_repulsive.log");
    ...
    using real_type = T;
    {
        ...
        const auto g = mjolnir::read_go_contact_repulsive_potential<real_type>(v, env);
        BOOST_TEST(g.k()  == real_type(3.14), tolerance<real_type>());
        BOOST_TEST(g.v0() == real_type(2.71), tolerance<real_type>());
    }
}

BOOST_AUTO_TEST_CASE_TEMPLATE(read_go_contact_repulsive_env, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_go_contact_repulsive.log");
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_local_potential_go_contact_repulsive_noenv, T, test_types)
{
    ...
    using real_type = T;
    {
        ...
        const auto g = mjolnir::read_local_potential<2,
            mjolnir::GoContactRepulsivePotential<real_type>>(v);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(read_local_potential_go_contact_repulsive_env, T, test_types)
{
    mjolnir::LoggerManager::set_default_logger("test_read_harmonic.log");
