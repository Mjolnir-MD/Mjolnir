#define BOOST_TEST_MODULE "test_periodic_cell_list"
...
BOOST_AUTO_TEST_CASE(test_CellList_PeriodicBoundary_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_cell_list.log");
    using traits_type     = mjolnir::SimulatorTraits<double, mjolnir::CuboidalPeriodicBoundary>;
    using real_type       = typename traits_type::real_type;
    ...
    using coordinate_type = typename traits_type::coordinate_type;
    using potential_type  = dummy_potential<real_type>;
    using cell_list_type  = mjolnir::PeriodicGridCellList<traits_type, potential_type, false>;
    ...
    mjolnir::SpatialPartition<traits_type, potential_type> vlist(
            mjolnir::make_unique<cell_list_type>(margin));
...
BOOST_AUTO_TEST_CASE(test_PeriodicGridCellList_partial_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_periodic_grid_cell_list.log");
    using traits_type     = mjolnir::SimulatorTraits<double, mjolnir::CuboidalPeriodicBoundary>;
    using real_type       = typename traits_type::real_type;
...
BOOST_AUTO_TEST_CASE(test_PeriodicGridCellList_partial_2_interchange)
{
    mjolnir::LoggerManager::set_default_logger("test_periodic_grid_cell_list.log");
    using traits_type     = mjolnir::SimulatorTraits<double, mjolnir::CuboidalPeriodicBoundary>;
    using real_type       = typename traits_type::real_type;
