#define BOOST_TEST_MODULE "test_read_angular_gaussian_potential"

#include <boost/test/included/unit_test.hpp>
#include <mjolnir/input/read_potential.hpp>

BOOST_AUTO_TEST_CASE(read_angular_gaussian_double)
{
    mjolnir::LoggerManager::set_default_logger("test_read_angular_gaussian.log");
    ...
    constexpr real_type tol = 1e-8;
    {
        ...
        const auto g = mjolnir::read_angular_gaussian_potential<real_type>(v);
...
BOOST_AUTO_TEST_CASE(read_angular_gaussian_float)
{
    mjolnir::LoggerManager::set_default_logger("test_read_angular_gaussian.log");
...
BOOST_AUTO_TEST_CASE(read_local_potential_angular_gaussian_double)
{
    mjolnir::LoggerManager::set_default_logger("test_read_angular_gaussian.log");
    ...
    constexpr real_type tol = 1e-8;
    {
        ...
        const auto g = mjolnir::read_local_potential<2,
              mjolnir::AngularGaussianPotential<real_type>>(v);
...
BOOST_AUTO_TEST_CASE(read_local_potential_angular_gaussian_float)
{
    mjolnir::LoggerManager::set_default_logger("test_read_angular_gaussian.log");
