...
template<typename realT, template<typename, typename> class boundaryT, typename potT>
void GlobalStoichiometricInteraction< OpenMPSimulatorTraits<realT, boundaryT>, potT>
...
template<typename realT, template<typename, typename> class boundaryT, typename potT>
typename GlobalStoichiometricInteraction<OpenMPSimulatorTraits<realT, boundaryT>, potT>
::real_type GlobalStoichiometricInteraction<OpenMPSimulatorTraits<realT, boundaryT>, potT>
