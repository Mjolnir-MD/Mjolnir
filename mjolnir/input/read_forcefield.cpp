...
template ForceField<SimulatorTraits<double, UnlimitedBoundary>       > read_forcefield(const toml::table& root, std::size_t N);
template ForceField<SimulatorTraits<float,  UnlimitedBoundary>       > read_forcefield(const toml::table& root, std::size_t N);
template ForceField<SimulatorTraits<double, CuboidalPeriodicBoundary>> read_forcefield(const toml::table& root, std::size_t N);
template ForceField<SimulatorTraits<float,  CuboidalPeriodicBoundary>> read_forcefield(const toml::table& root, std::size_t N);
} // mjolnir
