#ifndef MJOLNIR_FORCEFIELD_3SPN2_BASE_PAIR_POTENTIAL_HPP
#define MJOLNIR_FORCEFIELD_3SPN2_BASE_PAIR_POTENTIAL_HPP
...
// will only be used by ThreeSPN2BasePairIntearction.
...
class ThreeSPN2BasePairPotential
{
  public:
  ...
  public:
    ...
    ThreeSPN2BasePairPotential() noexcept {}
    ...
    static const char* name() noexcept {return "3SPN2BasePair";}
};

template<typename traitsT>
class ThreeSPN2BasePairParameterList : public ParameterListBase<traitsT,
    ThreeSPN2BasePairPotential<typename traitsT::real_type>>
{
  public:
  ...
  public:
    ...
    ThreeSPN2BasePairParameterList(ParameterSet para_set,
          ...
          exclusion_list_(exclusions, std::move(ignore_mol), std::move(ignore_grp))
    {
        ...
        for(const auto& idxp : parameters)
        {
            ...
            {
                this->parameters_.resize(idx+1,
                    parameter_type{base_kind::X, potential_type::invalid()});
            }
            this->parameters_.at(idx) = idxp.second;
        }
    }
    ~ThreeSPN2BasePairParameterList() override {}
    ThreeSPN2BasePairParameterList(const ThreeSPN2BasePairParameterList&) = default;
    ThreeSPN2BasePairParameterList(ThreeSPN2BasePairParameterList&&)      = default;
    ThreeSPN2BasePairParameterList& operator=(const ThreeSPN2BasePairParameterList&) = default;
    ThreeSPN2BasePairParameterList& operator=(ThreeSPN2BasePairParameterList&&)      = default;
    ...
    pair_parameter_type prepare_params(std::size_t i, std::size_t j) const noexcept override
    {
        ...
        return pair_parameter_type{
            para_i.S_idx, para_j.S_idx, this->bp_kind(para_i.base, para_j.base)
        };
    }
    ...
    {
        return new ThreeSPN2BasePairParameterList(*this);
    }
...
template<typename realT>
struct ThreeSPN2BasePairGlobalPotentialParameter
{
    using real_type = realT;
...
template<typename realT>
struct ThreeSPN2CBasePairGlobalPotentialParameter
{
    using real_type = realT;
...
namespace mjolnir
{
extern template class ThreeSPN2BasePairParameterList<SimulatorTraits<double, UnlimitedBoundary>       >;
extern template class ThreeSPN2BasePairParameterList<SimulatorTraits<float,  UnlimitedBoundary>       >;
extern template class ThreeSPN2BasePairParameterList<SimulatorTraits<double, CuboidalPeriodicBoundary>>;
extern template class ThreeSPN2BasePairParameterList<SimulatorTraits<float,  CuboidalPeriodicBoundary>>;
} // mjolnir
